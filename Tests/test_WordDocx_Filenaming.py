...
TEST_OUT_DIR = os.path.join(Definitions.TEST_OUT_DIR, 'Word', 'File_naming')
...
class TestNaming(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.id = 'word'
        cls.ext = '.docx'
        localtest = cls.test_directory + cls.filename + cls.sep + cls.id + cls.ext
    ...
    def test_source_provided_translation(self):
        ...
        local_filepath = TestNaming().test_directory + TestNaming().filename + TestNaming().sep + TestNaming().id \
                         + TestNaming().sep + name + TestNaming().ext

        # Test translation:
        doc = Document(local_filepath)
        line = doc.paragraphs[0]._line
    ...
    def test_translated_name(self):
        ...
        local_filepath = TestNaming().test_directory + 'Ahoj_svět_slovo_' \
                         + name + TestNaming().ext
    ...
    def test_translated_and_dest_abbreviation_naming(self):
        ...
        local_filepath = TestNaming().test_directory + 'Bonjour_monde_mot' \
